import pygame
from the_game_V1_2 import play_game
...
class Hub:
    ...
    def __init__(self):
        ...
        self.custom_colour = p_load(
            open('data/data/custom_colour_data.bat', 'rb'))
            ...
            for index, rect in enumerate(colour_rect):
                if rect.collidepoint(mouse_pos):
                    ...
                    p_dump((self.colour, self.default_colour),
                           open('data/data/colour_data.bat', 'wb'))
    ...
    def change_ui_button_pos(self, change, cog_slide=0):
        ...
        if change:
            if pos_text_rect.collidepoint(mouse_pos):
                ...
                p_dump(self.ui_button_pos, open('data/data/ui_button_data.bat', 'wb'))
        ...
        while True:
            ...
            if self.colour_input:
                ...
                p_dump(self.custom_colour, open(
                    'data/data/custom_colour_data.bat', 'wb'))
...
level_button = pygame.image.load(
    'data/assets/level_button.png').convert_alpha()
level_button_template = pygame.image.load(
    'data/assets/level_button_template.png').convert_alpha()
highlighted_level_button = pygame.image.load(
    'data/assets/highlighted_level_button.png').convert_alpha()
hub_button = pygame.image.load('data/assets/hub_button.png').convert_alpha()
hub_button_selected = pygame.image.load(
    'data/assets/hub_button_selected.png').convert_alpha()
...
option_background = pygame.image.load(
    'data/assets/option_background.png').convert_alpha()
slider_bob = pygame.image.load('data/assets/slider_bob.png').convert_alpha()
slider_selected = pygame.image.load(
    'data/assets/slider_selected.png').convert_alpha()
slider = pygame.image.load('data/assets/slider.png').convert_alpha()
colour_selected = pygame.image.load(
    'data/assets/colour_selected.png').convert_alpha()
colour_input_box = pygame.image.load(
    'data/assets/colour_input_box.png').convert_alpha()
colour_input_box_selected = pygame.image.load(
    'data/assets/colour_input_box_selected.png').convert_alpha()
no_custom_level_text = pygame.image.load(
    'data/assets/no_custom_level_text.png').convert_alpha()

info_stickman = pygame.image.load(
    'data/assets/stickman/info_stickman.png').convert_alpha()
help_stickman = pygame.image.load(
    'data/assets/stickman/help_stickman.png').convert_alpha()
quit_stickman = pygame.image.load(
    'data/assets/stickman/quit_stickman.png').convert_alpha()
options_stickman = pygame.image.load(
    'data/assets/stickman/options_stickman.png').convert_alpha()
levels_stickman = pygame.image.load(
    'data/assets/stickman/levels_stickman.png').convert_alpha()
continue_stickman = pygame.image.load(
    'data/assets/stickman/continue_stickman.png').convert_alpha()
custom_lev_stickman = pygame.image.load(
    'data/assets/stickman/custom-lev_stickman.png').convert_alpha()
