...
def create_level(level_name='', renamable=True):
    ...
    class MainGame:
        ...
        def draw_elements(self):
            ...
            for x, y in level_temp:
                coloured_box = pygame.rect.Rect(x, y, box_size, box_size)
                ...
                for event in pygame.event.get():
                    ...
                    if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:
                        ...
                        if index == 0:
                            ...
                            p_dump(level, open('data/custom levels/' + str(self.level_name) +'X.bat', 'wb'))
                            self.go_to_hub = True
        ...
        def rename_level(self):
            ...
            while True:
                ...
                if not close and size != 100:
                    ...
                    new_name = 'data/custom levels/'+self.rename_name+'X.bat'
                    old_name = 'data/custom levels/'+self.level_name+'X.bat'
    ...
    maingame = MainGame()
    level = p_load(open('data/custom levels/' + str(level_name) + 'X.bat', 'rb'))
    ...
    space_temp = pygame.image.load('data/assets/space_temp.png').convert_alpha()
    black_wood_background = pygame.image.load('data/assets/black_wood_background.png').convert_alpha()
    black_ball = pygame.image.load('data/assets/black_ball.png').convert_alpha()
    menu_temp = pygame.image.load('data/assets/menu_temp.png').convert_alpha()
    menu_temp_text = pygame.image.load('data/assets/menu_temp_text.png').convert_alpha()
    ...
    no_save = pygame.image.load('data/assets/no_save.png').convert_alpha()
    rename_icon = pygame.image.load('data/assets/rename_icon.png').convert_alpha()
    confirm_page = pygame.image.load('data/assets/confirm_page.png').convert_alpha()
    rename_box = pygame.image.load('data/assets/rename_box.png').convert_alpha()
    rename_text_underline = pygame.image.load('data/assets/rename_text_underline.png').convert_alpha()
    ...
    center_pos = menu_background.get_rect(topleft=(0, 0))
    ...
    error_sound = pygame.mixer.Sound('data/sound/error_sound.wav')
    ...
    while True:
        ...
        if x_slide == 0:
            ...
            if button[0] and pygame.key.get_pressed()[pygame.K_LSHIFT]:
